...
public class XLuaAssignmentPacket implements ISerial {
    ...
    public XLuaAssignmentPacket() { }
    public XLuaAssignmentPacket(Bundle b) { fromBundle(b); }
    public XLuaAssignmentPacket(List<String> hookIds, String packageName, Integer uid, Boolean delete, Boolean kill) {
    ...
    public static XLuaAssignmentPacket createFromBundle(Bundle b) { return new XLuaAssignmentPacket(b); }
    public static XLuaAssignmentPacket create(List<String> hookIds, String packageName, Integer uid, Boolean delete, Boolean kill) {
        return new XLuaAssignmentPacket(hookIds, packageName, uid, delete, kill);
    }
}
