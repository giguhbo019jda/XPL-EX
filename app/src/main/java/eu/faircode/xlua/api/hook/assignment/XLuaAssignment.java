...
public class XLuaAssignment extends XLuaAssignmentBase implements ISerial, IDBSerial, IJsonSerial, Parcelable {
    public XLuaAssignment() { }
    public XLuaAssignment(Parcel p) { fromParcel(p); }
    public XLuaAssignment(XLuaHook hook) {
        this.hook = hook;
    }
    ...
    public static final Parcelable.Creator<XLuaAssignment> CREATOR = new Parcelable.Creator<XLuaAssignment>() {
        @Override
        public XLuaAssignment createFromParcel(Parcel source) {
            return new XLuaAssignment(source);
        }

        @Override
        public XLuaAssignment[] newArray(int size) {
            return new XLuaAssignment[size];
        }
    };
