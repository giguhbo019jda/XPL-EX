...
public class PackageContextPacket implements IJsonSerial, IDBQuery, IPacket {
    ...
    public static PackageContextPacket create() { return new PackageContextPacket(XLuaSettingsDatabase.GLOBAL_USER, XLuaSettingsDatabase.GLOBAL_NAMESPACE); }
    ...
    public void fromBundle(Bundle b) {
        ...
        this.packageName = BundleUtil.readString(b, "packageName", XLuaSettingsDatabase.GLOBAL_NAMESPACE);
    }
    ...
    public void fromContentValues(ContentValues contentValue) {
        ...
        this.packageName = ContentValuesUtil.getString(contentValue, "packageName", XLuaSettingsDatabase.GLOBAL_NAMESPACE);
    }
