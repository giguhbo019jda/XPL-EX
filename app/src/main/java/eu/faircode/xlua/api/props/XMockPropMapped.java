...
public class XMockPropMapped extends XMockPropMappedBase implements IJsonSerial, Parcelable {
    public XMockPropMapped() { }
    public XMockPropMapped(Parcel in) { fromParcel(in); }
    public XMockPropMapped(Bundle bundle) { fromBundle(bundle); }

    public XMockPropMapped(ContentValues cv) { fromContentValues(cv); }
    public XMockPropMapped(String propertyName, String settingName) { super(propertyName, settingName); }
    public XMockPropMapped(String propertyName, String settingName, Boolean enabled) { super(propertyName, settingName, enabled); }
    ...
    public static final Parcelable.Creator<XMockPropMapped> CREATOR = new Parcelable.Creator<XMockPropMapped>() {
        @Override
        public XMockPropMapped createFromParcel(Parcel source) {
            return new XMockPropMapped(source);
        }

        @Override
        public XMockPropMapped[] newArray(int size) {
            return new XMockPropMapped[size];
        }
    };
